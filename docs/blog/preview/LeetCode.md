...
- 0101...对于每个字符串的下标位置i需要满足`int(s[i]) % 2 == i % 2`
- 1010...对于每个字符串的下标位置i需要满足`int(s[i]) % 2 != i % 2`
...
对于每个子串，既可以改成 0101⋯，又可以改成 1010⋯，取最小值，用 min(cnt,n−cnt)
更新答案的最小值。

题解参考：[灵茶山艾府](https://leetcode.cn/problems/minimum-number-of-flips-to-make-the-binary-string-alternating/solutions/815298/cong-qian-wang-hou-pi-pei-cong-hou-wang-uiq6a/?envType=daily-question&envId=2026-03-07)
:::code-tabs
@tab C++
